...
public class GameManager : MonoBehaviour
{
    ...
    public static StarScript[] stars;
    ...
    public void Start()
    {
        GameManager.stars = GameObject.FindObjectsByType<StarScript>(FindObjectsSortMode.None);
        ...
        for (int i = 0; i < stars.Length; i++)
        {
            ...
            stars[i].rb.velocity = tangent * orbitalSpeed * rotation_direction * (random_extra_boost);
        }
